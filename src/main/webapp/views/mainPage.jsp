...
<head>
    ...
    <link rel="shortcut icon" href="<c:url value = "/resources/main_page/images/shortcut-icon.png" />" type="image/x-icon">
        ...
        <div class="row">
            <div class="col-3">
                ...
                <div class="program-menu d-flex flex-column">
                    ...
                    <div class="program-menu--item" style="background: url('<c:url value = "/resources/main_page/images/secret-lab-label.svg" />')' no-repeat; background-position: right;">
                        Secret Lab
                    </div>
                </div>
            </div>
