...
<body>
    ...
    <script>
        ...
        document.getElementById('under-start-wall').innerHTML = c.lessonOne
    </script>
    <script src="/resources/template/mvc/Controller.js"></script>
    <script src="/resources/template/mvc/Model.js"></script>
    <script src="/resources/lesson1/js/View.js"></script>
    <script src="/resources/lesson1/js/main.js"></script>
</body>
</html>
