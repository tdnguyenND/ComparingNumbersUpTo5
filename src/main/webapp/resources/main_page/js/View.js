View = function(){
    ...
    let greenArrowSrc = "../resources/main_page/images/31.png"
    let redArrowSrc = "../resources/main_page/images/33.png"
    let XSignSrc = "../resources/main_page/images/71.png"
    ...
    this.drawBlocks = function(blockInformation) {
        ...
        for (let i = 0; i < blockInformation.number; i++) {
            html += `<img name="block" class="block block_${i}" src="../resources/main_page/images/block.png" alt="">`
        }
